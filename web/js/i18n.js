...
var I18N = {
  en: {
    ...
    legendSusfsProbeNone: 'SUSFS · the probe found no monthly release where the raw patch applies and builds',
    legendSusfsUnknown: '{n} releases not probed',
  ...
  zh: {
    ...
    legendSusfsProbeNone: 'SUSFS · 探测显示本分支的月份版本里没有原始补丁能直接应用并编译成功的',
    legendSusfsUnknown: '{n} 个版本未探测',
